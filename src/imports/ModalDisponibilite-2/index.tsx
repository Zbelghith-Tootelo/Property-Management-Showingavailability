import svgPaths from "./svg-b526kv6l7v";
...
function BtnSupprimer() {
  return (
    <div className="bg-white content-stretch flex h-[42px] items-center justify-center px-[16px] relative rounded-[6px] shrink-0 w-[150px]" data-name="btn-supprimer">
      <div aria-hidden className="absolute border border-[#c8102e] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#c8102e] text-[14px] whitespace-nowrap">Supprimer</p>
    </div>
  );
}
